...
import {
  RenderFileWithPreview,
  TaskTerm,
} from "@/components/task-form/task-term";
  ...
  return (
    <Dialog>
      ...
      <DialogContent size="4xl" className="max-h-[80vh] overflow-auto">
        ...
        <p className="py-[10px] px-4 rounded-[8px] bg-primary mt-[10px] text-white text-xs font-bold text-center">
          "خلال الفحص، لوحظ أن إجراءات التعقيم في قسم الطوارئ ليست متبعة بدقة.
          يُوصى بإجراء مراجعة شاملة وتدريب إضافي للفريق الطبي لضمان الالتزام
          الكامل بالبروتوكولات الصحية."
        </p>
