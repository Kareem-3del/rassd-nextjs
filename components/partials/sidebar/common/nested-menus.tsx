  ...
  return (
    <Collapsible open={activeSubmenu === index}>
      <CollapsibleContent className="CollapsibleContent">
        <ul className="sub-menu  space-y-4 relative before:absolute rtl:before:right-4 ltr:before:left-4 before:top-0  before:h-[calc(100%-5px)]  before:w-[3px] before:bg-primary/10 before:rounded">
          {item.child?.map((subItem: any, j: number) => (
            <li
              className={cn(
                "block ltr:pl-9 rtl:pr-9     first:pt-4 last:pb-4  relative before:absolute first:before:top-4 before:top-0 rtl:before:right-4 ltr:before:left-4  before:w-[3px]",
                {
