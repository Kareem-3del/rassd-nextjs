    ...
    <div className="flex gap-5 app-height relative rtl:space-x-reverse ">
      {isLg && showContactSidebar && (
        <div
         ...
         backdrop-blur-sm absolute w-full flex-1 inset-0 z-[99] rounded-2xl"
      ...
      {isLg && showInfo && (
        <div
          className=" bg-background/60 backdrop-filter
         backdrop-blur-sm absolute w-full flex-1 inset-0 z-40 rounded-2xl"
      ...
      >
        <Card className="h-full pb-0 rounded-2xl flex flex-col">
          <CardHeader className="border-none pb-0 mb-0 px-7 py-5">
            <div className="flex gap-4 items-center">
              <div className="h-[36px] w-1 rounded-sm bg-primary" />
